...
class Encoder(nn.Module):
    ...
    def __init__(self, params, cls_tok, vocab_size, max_seq_pos,pretrain_snv_toks: Tokenised_SNVs) -> None:
        super().__init__()
        ...
        self.pos_encoding = ExplicitPositionalEncoding(pretrain_snv_toks, self.pos_size, max_len=max_seq_pos + 1 )# 
        self.blocks = []
