...
def logistic():
    ...
    net_file = saved_nets_dir + "logistic_{}val".format(num_phenos)
...
def mlp():
    ...
    train_logistic_mlp(params, net, train, test)
    net_file = saved_nets_dir + "mlp_{}val".format(num_phenos)
    summarise_net(net, test, params, net_file)
...
def prs_score_logistic():
    ...
    net_file = saved_nets_dir + "pheno_tin_scores"
    summarise_net(net, test, params, net_file)
...
def tin_pheno_prs():
    ...
    train_logistic_mlp(params, net, train, test)
    net_file = saved_nets_dir + "pheno_tin"
    summarise_net(net, test, params, net_file)
...
def tin_prs():
    ...
    net_file = saved_nets_dir + "reuse_tin"
    summarise_net(net, test, params, net_file)
